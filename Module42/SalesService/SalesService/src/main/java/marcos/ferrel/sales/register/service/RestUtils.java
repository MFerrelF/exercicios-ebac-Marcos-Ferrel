...
public class RestUtils {
	...
	private void logCall(HttpMethod method, String url, HttpEntity<?> httpEntity, Object[] uriVariables) {
		...
		logger.debug("EXECUTING ENDPOINT with {} in URL: {}, PARAMETERS: {}, HEADERS: {} AND BODY: {}", method, url, uriVariables, asJSON(headers), asJSON(body));
	}
	
	private void logError(HttpMethod method, String url, Exception e) {
		logger.error("ENDPOINT ERROR with {} in URL: {} - {}", method, url, e.getMessage());
	}
